...
/*
 * i've just rip this off from the person above, this is not mine 
 */
...
public class Properties {
    ...
    private static  java.util.Properties parentProperties;
    
    public static java.util.Properties getParentProperties() {
		return parentProperties;
	}

	public static void setParentProperties(java.util.Properties parentProperties) {
		Properties.parentProperties = parentProperties;
	}
    ...
    public boolean contains(String[] sArray){
    	
    	// convert array to list
    	List<String> lList = Arrays.asList(sArray);

    	//enumerate each key
    	for (String thisKey : lList) {
    ...
    public static Properties load(String filename) throws IOException {
        ...
        parentProperties = new java.util.Properties();
        
        stream = new FileInputStream(filename);
        parentProperties.load(stream);
        stream.close();
        
        Properties prop = new Properties();
        return prop.putAll(parentProperties);
    }
    public static void main(String[] args){
    	System.out.println("Im on Properties");
    }
}
